<template>
    <div class="flex h-[calc(100vh-64px)] overflow-hidden grow relative">
        <!-- left column -->
        <div class="absolute z-10 w-64 h-full p-4 space-y-8 overflow-y-auto bg-gray-100 border-r border-orange-500 shadow-lg lg:static dar:border-orange-500 whitespace-nowrap dark:bg-gray-800 lg:block" :class="isOpenAsideMenu ? 'block' : 'hidden'">
